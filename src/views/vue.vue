<template id="hot">
  <div class="home">
    ...
    <div class="new">
      ...
      <div class="shijiu">
        <p class="heiha">24.拖拽</p>
        <div style="display:flex;flex-direction:row">
          <div style="width: 200px;
          height: 300px;border:1px solid gray">
            <div v-for="item in stringData" draggable="true" @dragstart="draStart(item,'startweidu')" @dragend="draEnd">
          ...
          <div class="dimensionality-small overflowy" @dragover="drgOver('weidu')" style="width: 200px;
          height: 300px;border:1px solid gray">
            <div v-for="(item,index) in dimensionData">
